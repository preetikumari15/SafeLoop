...
const Step1_Thought = ({onNext}) => {
    ...
    return (
        <div className="relative min-h-screen bg-slate-900 font-sans antialiased overflow-hidden">
            {/* Background with gradient and floating thoughts */}
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8 text-center">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-12 max-w-4xl">
                    <h1 className="text-7xl font-bold text-pink-300 text-shadow-lg mb-10">
                        Hey! overthinking again? 💭
                    </h1>

                    <p className="text-3xl text-slate-300 text-shadow leading-relaxed mb-12">
                        It's okay. Your mind is just trying to keep up. 
                        You're not alone in this.
                    </p>

                    <div className="bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-xl p-8 mb-12">
                        <p className="italic text-purple-300 text-shadow text-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <button
                            onClick={onPlayGame}
                            className="px-8 py-4 bg-pink-500/20 backdrop-blur-sm rounded-xl
